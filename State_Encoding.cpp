...
namespace Encoding {
	...
	static constexpr inline void swap_data(DataBorders& pos, DataBorders& rot, int a, int b, int c, int d) {
		uchar t= pos[d];
		pos[d] = pos[c];
		pos[c] = pos[b];
		pos[b] = pos[a];
	...
	static constexpr inline void swap_data(DataCorners& pos, DataCorners& rot, int a, int b, int c, int d) {
		uchar t= pos[d];
		pos[d] = pos[c];
		pos[c] = pos[b];
		pos[b] = pos[a];
	...
	static constexpr inline void swap_data_poles(DataCorners& pos, DataCorners& rot, int a, int b, int c, int d) {
		uchar t= pos[d];
		pos[d] = pos[c];
		pos[c] = pos[b];
		pos[b] = pos[a];
	...
	void constexpr _apply_movement(Data& data, int m) {
		...
		switch (m) {
			...
			case State::Up ://TODO combine pos and rot for easy swapping
